        ...
        if(alreadyExistingTag) {
            ...
            try( ITransaction transaction = modelingSession.createTransaction(Messages.getString ("Info.Session.Create", TaggedValue.MNAME))){
                ...
                TaggedValue customTag = modelingSession.getModel().createTaggedValue(IAttackTreeDesignerPeerModule.MODULE_NAME, 
                        ...
                        AddCustomTagDialog.this.selectedElement);
                TagsManager.createTagParameter(modelingSession, customTag, AddCustomTagDialog.this.propertyNameText.getText());
                TagsManager.addTagParameter(modelingSession, customTag, AddCustomTagDialog.this.propertyValueText.getText());
